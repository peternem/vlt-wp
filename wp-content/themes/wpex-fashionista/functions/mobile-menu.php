...
if ( ! function_exists( 'wpex_mobile_menu' ) ) {
	function wpex_mobile_menu() {
		...
		echo '<div id="sidr-close"><a href="#sidr-close" class="toggle-sidr-close"></a></div><a href="#sidr" class="mobile-menu-toggle">'. __('<span class="sr-only">Menu</span>','wpex') .'<!--<span class="fa fa-caret-down"></span--></a>';
	}
}