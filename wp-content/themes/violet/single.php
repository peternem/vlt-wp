    ...
    <section>
      <div class="style-entry">
        <div class="text">
          ...
          <a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="symple-button black">Make this yours</span></a> 
        </div>
        <div class="collage">
          <?php
        ...
        <?php
 		...
 		$imageThumbURL = $imageArray['sizes']['medium']; //grab from the array, the 'sizes', and from it, the 'thumbnail'
 		?>
        <img src="<?php echo $imageThumbURL;?>" alt="<?php echo $imageAlt; ?>" class="col"> </div>
      </div>
